...
- Composants Angular standalone exportés via `src/public-api.ts` — `ConfirmDialogComponent`, `ToastComponent`, `PasswordStrengthComponent` + services `ToastService`, `PasswordPolicyService` (selectors `pivot-ds-*`)
